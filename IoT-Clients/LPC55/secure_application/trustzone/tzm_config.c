...
- ahb:
  - regions:
    - relative_region: {memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00040000'}
    - relative_region: {memory: PROGRAM_FLASH, security: ns_user, start: '0x00040000', size: '0x00060000'}
    - relative_region: {memory: BootROM, security: s_priv, start: '0x00000000', size: '0x00020000'}
...
- sau:
  ...
  - regions:
    ...
    - region: {index: '1', enabled: 'true', security: ns, start: '0x20000000', size: '0xD0000000'}
    - region: {index: '2', enabled: 'true', security: nsc, start: '0x1003FE00', size: '0x00000200'}
...
- user_memory_regions:
  - user_memory_region: {id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0003FE00'}
  - user_memory_region: {id: Region_2, security: nsc_priv, name: Veneer Table, start: '0x1003FE00', size: '0x00000200'}
  - user_memory_region: {id: Region_3, security: s_priv, name: Secure Stack and Data, start: '0x30000000', size: '0x00010000'}
  - user_memory_region: {id: Region_4, security: ns_user, name: Non-secure Code, description: Privilege check is disabled so reset value (NS-User) can be used,
    start: '0x00040000', size: '0x00060000'}
  - user_memory_region: {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can
      be used. ', start: '0x20010000', size: '0x00034000'}
- mpus:
  - mpu:
    - enabled: 'false'
    - id: 's'
